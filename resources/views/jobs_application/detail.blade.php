...
@section('breadcrumb')
  @include('layout.custom_breadcrumb', [
    "arr" => Request::has('from') ? (
      Request::get('from') == "jobs_recommendation" ? [
        __('general.jobs_recommendation'),
        __('jobs_recommendation.detail'),
        __('jobs.detail'),
        __('jobs_application.detail'),
      ] : (
        Request::get('from') == "customer" ? [
          __('general.customer'),
          __('customer.detail'),
          __('jobs_recommendation.detail'),
          __('jobs.detail'),
    ...
    "title" => __('jobs_application.detail'),
  ])
@endsection
...
@section('content')
  ...
  @include('jobs_application.component.modal.modal_interview')
