<div>
  <div class="mt-3 table-responsive">
    <table class="table w-100" id="list_check_in_datatable">
      <thead>
        <tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    jobs_datatable = $('#list_check_in_datatable').DataTable({
      "processing" : true,
      "serverSide" : true,
      bLengthChange: false,
      responsive: true,
      ...
      "ajax" : {
        url : "{{ url('api/check-log').'?type=check_in&jobs_shift_id='.$jobs_shift->id }}",
        type : "GET",
        dataType : "json",
        headers : {
