<div>
  <div class="mt-3 table-responsive">
    <table class="table w-100" id="list_approve_check_log_datatable">
      <thead>
        <tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    user_datatable = $('#list_approve_check_log_datatable').DataTable({
      "processing" : true,
      "serverSide" : true,
      bLengthChange: false,
      responsive: true,
      ...
      "ajax" : {
        url : "{{ url('api/jobs/approve/check-log') }}?jobs_id={{ $jobs->id }}",
        type : "GET",
        dataType : "json",
        headers : {
