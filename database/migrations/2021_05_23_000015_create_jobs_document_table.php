...
class CreateJobsDocumentTable extends MigrationHelper
{
  /**
  * Run the migrations.
  *
  ...
  */
  ...
  {
    $context = $this;
    Schema::create('jobs_document', function (Blueprint $table) use($context) {
  ...
  */
  ...
  {
    Schema::dropIfExists('jobs_document');
  }
}
