...
class CreateJobsApproveCheckLogTable extends MigrationHelper
{
  /**
  * Run the migrations.
  *
  ...
  */
  ...
  {
    $context = $this;
    Schema::create('jobs_approve_check_log', function (Blueprint $table) use($context) {
  ...
  */
  ...
  {
    Schema::dropIfExists('jobs_approve_check_log');
  }
}
