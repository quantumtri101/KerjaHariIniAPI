...
class CreateAdditionalSalaryDocumentTable extends MigrationHelper
{
  /**
  * Run the migrations.
  *
  ...
  */
  ...
  {
    $context = $this;
    Schema::create('additional_salary_document', function (Blueprint $table) use($context) {
  ...
  */
  ...
  {
    Schema::dropIfExists('additional_salary_document');
  }
}
