...
class EducationController extends BaseController{
  ...
  public function action(Request $request){
    ...
    return $this->get_data_helper->return_data($request, [], 'view', 'master.education.action', [
      'education' => $data,
    ]);
  }

  public function multiple(Request $request){
    return $this->get_data_helper->return_data($request, [], 'view', 'master.education.multiple_add', []);
  }

  public function multiple_post(Request $request){
    $arr_education = json_decode($request->arr_education, true);

    foreach($arr_education as $education){
      $data = new Education();
      $data->is_publish = $education['is_publish'];
