...
class ReminderCheckIn extends Command
{
  /**
  ...
  * @var string
  */
  protected $signature = 'reminder:check_in';
  ...
  public function handle()
  {
    ...
    foreach($arr_shift as $shift){
      ...
      foreach($arr_application as $application)
        $this->communication_helper->send_push_notif($user, 'Reminder Check In', 'Anda memiliki Pekerjaan '.$application->jobs->name.' Hari ini', ["id" => $application->jobs->id, 'type' => "jobs_reminder"]);
    }
  }
}
